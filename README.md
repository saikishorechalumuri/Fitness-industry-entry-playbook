...
# MODULE 1 — MSR / Front Desk Role

## Main mission
**First impression + daily operations + member experience.**

## Core responsibilities
- Member greeting + check-ins + daily experience control
- Phone + email handling (inquiries, follow-ups, basic support)
- Support tours + clean lead handoffs to sales/management
- Enforce policies professionally (calm, clear, consistent)
- Document notes: incidents, follow-ups, cancellations
- Maintain desk professionalism + club standard checks
- Support office orders + inventory basics

## Success metrics (how you’re judged)
- Response speed (calls/emails/issues)
- Member satisfaction + professionalism
- Clean documentation (clear notes, closed loops)
- Fewer escalations (because you solved it properly)
- Strong handoffs (no dropped leads / no dropped issues)

---

# MODULE 2 — Skills You Need
## Core skills for MSR / Front Desk
- Customer service + conflict handling
- Professional communication (phone/email)
- Basic sales confidence (tours, booking, handoffs)
- Operations discipline (checklists, documentation)
- Excel + reporting basics
- Time management under pressure
- Ownership mindset (treat the club like it’s yours)

## Leadership habits I expect
- **FIFBM: Figure It First** (try to solve within your scope)
- **1 Problem → 3 Solutions** (bring options, not only problems)
- **Close the loop** (confirm, document, follow-up)
...
# MODULE 4 — Top 10 Interview Scenarios (Practice These)
Use this answer format every time:
1) Empathy  
2) Clarify  
3) 2–3 Solutions  
4) Confirm next step  
5) Document + escalate only if needed  

1. Angry member about billing  
2. Member wants to cancel today  
3. “I hate this gym” (service recovery)  
4. Tour lead late / no show  
5. Rush hour line-up (20+ people waiting)  
6. Two members arguing  
7. Trainer late and member complains  
8. Equipment issue / safety hazard  
9. Member asks exception to policy  
10. You made a mistake — how do you fix it?
...
# BONUS — Resume: Top 10 Things to Highlight
- Customer service under pressure
- Phone/email communication
- Conflict resolution
- Team collaboration
- Documentation habits
- Tour support / lead booking / follow-up
- Excel/reporting
